...
var Skill_TYPE_ =
  ',Special Passing,Special Dribble,Special 1-2,Special Block,Special Tackle,Special Intercept';
var Skill_SHOT_ =
  '0C Drive Shot,50 Banana Shot,54 Buster Shot,88 DblEagle Shot,14 Falcon Shot (S),1C Razor Shot (S),2C Eagle Shot (S),30 Tiger Shot (S),34 Neo Tiger Shot (S),44 Drive Tiger Shot (S),48 Cyclone Shot (S),4C Sano Shot (S),58 Mirage Shot (S),5C Mach Shot (S),60 Sidewind Shot,64 Slider Shot (S),68 Cannon Shot (S),6C Fire Shot (S),00 ==========,25 Twin Volley (S),18 Falcon Volley (S),29 Skylab 2x Volley (S),41 Jumping Volley (S),49 Cyclone Volley (S),81 BackShot Volley (S),85 Slider Cannon Volley (S),00 ==========,72 Dyna Head,76 CnPower Head,7A Rocket Head,22 Skylab Head (?),12 Drive Bicycle (?),2A Skylab 2x Head (S),3A Bicycle Kick (S),3E Hyper Bicycle (S),4A Cyclone Head (S),7E Rising Dragon Head (S),86 Slider Cannon Head (S)';
...
; Lennart skill
3ae96=00 01 06 0E 09 09 0E 0D;

; Morisaki skill
3ae9e=0C 00 00 0D 0B 0B 0B 0D;
`,
  ],
  [
